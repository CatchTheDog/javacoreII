...
public class DownStreamCollectors {
    ...
    public static void main(String[] args) throws IOException {
        ...
        locales = Stream.of(Locale.getAvailableLocales());//印刷错误？
        ...
        Map<String, Long> countryLocalesCounts = locales.collect(Collectors.groupingBy(Locale::getCountry, Collectors.counting()));
        System.out.println("countryToLocaleCounts:" + countryLocalesCounts);
